namespace Server.Utilite
{
    public static class MySQLFormattedExpression
    {
        ...
        public readonly static string GetCharacterByLogin = @"select id as Id, score as Score, login_name as LoginName, name as Name from characters where login_name=@_login";
